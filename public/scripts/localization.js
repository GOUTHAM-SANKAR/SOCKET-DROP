class Localization {
    ...
    static logHelpCall() {
        console.log("Help translating SocketDrop: https://hosted.weblate.org/engage/socketdrop/");
    }
    ...
    static logHelpCallKey(key, attr) {
        ...
        console.warn(`Translate this string here: https://hosted.weblate.org/browse/socketdrop/socketdrop-spa/${locale}/?q=${keyComplete}`);
    }
